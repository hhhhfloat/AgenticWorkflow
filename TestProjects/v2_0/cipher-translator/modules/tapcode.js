...
const TapCodeCipher = (() => {
    ...
    function render(container, text) {
        ...
        visualRow.className = 'tapcode-visual-row';

        const displayChars = chars.slice(0, 10); // 最多显示10个字符的详细方格
        for (const ch of displayChars) {
            const cellWrapper = document.createElement('div');
            cellWrapper.className = 'tapcode-char-wrapper';

            const miniGrid = document.createElement('div');
            miniGrid.className = 'tapcode-mini-grid';
            ...
            for (let r = 0; r < 5; r++) {
                for (let c = 0; c < 5; c++) {
                    ...
                    cell.className = 'tapcode-grid-cell';
            ...
            label.className = 'tapcode-char-label';
